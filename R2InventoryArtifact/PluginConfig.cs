...
namespace R2InventoryArtifact
{
    ...
    public static class PluginConfig
    {
        ...
        public static void Initialize(ConfigFile config, BepInEx.PluginInfo pluginInfo)
        {
            ...
            UIVerticalPadding=config.Bind(
                section:        "UI", 
                key:            "UI Vertical Padding", 
                defaultValue:   2f, 
                description:    "Vertical UI Padding"
            ); 

            UIHorizontalPadding=config.Bind(
                section:        "UI", 
                key:            "UI Horizontal Padding", 
                defaultValue:   2f, 
                description:    "Horizontal UI Padding"
            ); 
            ...
            ModSettingsManager.AddOption(new StepSliderOption(UIVerticalPadding, new StepSliderConfig { min=1f, max=10f, increment=0.5f })); 
            ModSettingsManager.AddOption(new StepSliderOption(UIHorizontalPadding, new StepSliderConfig { min=1f, max=10f, increment=0.5f })); 
        }
    }
}