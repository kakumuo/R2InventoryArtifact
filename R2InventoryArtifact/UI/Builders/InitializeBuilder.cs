    ...
    public static partial class ComponentBuilder
    {
        ...
        public static void Initialize()
        {
            _spriteDict = new Dictionary<SpritePanelType, Sprite>
            {
                ...
                { SpritePanelType.TILE, Addressables.LoadAssetAsync<Sprite>("RoR2/Base/UI/texUIHighlightBoxOutlineThick.png").WaitForCompletion() },
        ...
        {
            return _spriteDict.GetValueOrDefault(type, null);
        }
    }
}
